...
export default function MyBets() {
    ...
    return (
        <div className="space-y-6 p-4 bg-gray-900">
            ...
            {/* Tabs Section */}
            <Tabs  defaultValue="active" className="w-full p-10" onValueChange={setActiveTab}>
                <TabsList className="grid h-full w-full grid-cols-2 text-gray-200  bg-gray-800 rounded-full overflow-hidden">
                    <TabsTrigger
                        value="active"
                        className={`flex items-center justify-center py-2 rounded-full px-4 text-sm font-medium transition-colors duration-300 ${activeTab === 'active'
                    ...
                    <TabsTrigger
                        value="expired"
                        className={`flex items-center justify-center py-2 px-4 rounded-full text-sm font-medium transition-colors duration-300 ${activeTab === 'expired'
